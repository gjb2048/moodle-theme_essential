...
function essential_get_nav_links($course, $sections, $sectionno) {
...
function essential_print_single_section_page(&$that, &$courserenderer, $course, $sections, $mods, $modnames, $modnamesused, $displaysection) {
    global $PAGE;
    ...
    // $sectionbottomnav .= html_writer::tag('div', $that->section_nav_selection($course, $sections, $displaysection), array('class' => 'mdl-align'));
