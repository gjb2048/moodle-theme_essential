...
// ui is an array.
var d=c.content.pop();a("#courseitemsearchtally").text(d.label)},select:function(a,b){var c=b.item.id;"#"!=c&&(location.href=c)}}).prop("disabled",!1);var d=a("#courseitemsearchtype");d.length?(c.debug("searchallcoursecontentenable enabled"),d.click(function(){var d=0|a(this).prop("checked");// Convert to integer from true or false.
