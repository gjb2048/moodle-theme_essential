...
$string['autohidedesc'] = 'Режим автоматического показа/скрытия иконок в режиме редактирования разработат для того, чтобы сделать Moodle более эстетичным. В режиме редактирования иконки показываются только для того блока, над которым находится курсор мыши.';
$string['editicons'] = 'Редактировать иконки В2';
$string['editiconsdesc'] = 'Эта утилита для шрифта Awesome отображает цветные и акуратно отформатированные иконки на страницах курса и блоках. Обратите внимание, что сейчас эта функция НЕ совместима с режимом автоскрытия.';
