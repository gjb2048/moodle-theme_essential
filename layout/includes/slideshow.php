            ...
            <div id="essentialCarousel" class="carousel slide" data-interval="<?php echo $slideinterval; ?>">
                <ol class="carousel-indicators">
                    ...
                    for ($i = 1; $i <= $numberofslides; $i++) {
                        ?>
                        <li data-target="#essentialCarousel" data-slide-to="<?php echo $i - 1; ?>" <?php if ($first) {
                            echo 'class="active"';
                            $first = false;
                        } ?>></li>
                    <?php } ?>
                        ...
                        if ((theme_essential_get_setting($slidetitle)) || (theme_essential_get_setting($slidecaption))) {
                            ...
                            <div class="carousel-caption">
                                <div class="carousel-caption-inner">
                                    <?php
                                    if (theme_essential_get_setting($slidetitle)) {
                                        echo '<h4>' . theme_essential_get_setting($slidetitle, true) . '</h4>';
                                    }
                                    if (theme_essential_get_setting($slidecaption)) {
                                        echo '<p>' . theme_essential_get_setting($slidecaption, true) . '</p>';
                                    }
                                    ?>
                                </div>
                            </div>
                ...
                <a class="left carousel-control" href="#essentialCarousel" data-slide="prev"><i
                        class="fa fa-chevron-circle-left"></i></a>
                <a class="right carousel-control" href="#essentialCarousel" data-slide="next"><i
