                ...
                <div class="row-fluid">
                    <div class="custommenus pull-left">
                        ...
                        <div class="nav-collapse collapse pull-left">
                            <div id="custom_menu_home">
                            <?php echo $OUTPUT->render_home_menu(); ?>
                            </div>
                            <div id="custom_menu_online_courses">
                            <?php echo $OUTPUT->render_oc_menu(); ?>
                            </div>
                            <div id="custom_menu_hands_on_courses">
                            <?php echo $OUTPUT->render_hoc_menu(); ?>
                            </div>
                            <div id="custom_menu_help">
                            <?php echo $OUTPUT->render_help_menu(); ?>
                            </div>
                            <div id="custom_menu_activities">
                            <?php echo $OUTPUT->render_activities_menu(); ?>
                            </div>
